      ...
      <section className='introduce'>
        <div className='introduce__content'>
          <div className='introduce__discount'>
            <h3>ƯU ĐÃI TRONG THÁNG - YEN YAKINIKU</h3>
          </div>
          <div className='introduce__banner'>
            <img src={DiscountBanner} alt='ƯU ĐÃI TRONG THÁNG - YEN YAKINIKU' />
          </div>
        </div>
      </section>
      <section className='customer'>
        <div className='container'>
          ...
          <p className='customer__text'>
            Sau lưng em không có ai cả. Nhưng trước mặt em là Yen Yakiniku
          </p>
