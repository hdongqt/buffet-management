      ...
      <Slider.CenterContent>
        <MotionContent variants={animations.fadeDropJump}>
          ...
          <Slider.Description>
            ...
            tôn chỉ duy nhất “mang ẩm thực Nhật Bản chuẩn chỉnh với mức giá hợp
            lý đến gần hơn với mọi người”, Sakura Buffet đặt ra những yêu cầu kỹ
            lưỡng từ không gian, món ăn cho đến phong cách phục vụ.
          </Slider.Description>

          <Slider.Description>
            Trải qua nhiều lần nâng cấp, Sakura Buffet tự hào càng ngày càng
            mang đến cho các thực khách những trải nghiệm ẩm thực hoàn hảo hơn
            nữa. Hệ thống cơ sở đặt tại vị trí đắc địa với thiết kế như một Nhật
            Bản hiện đại thu nhỏ; thực đơn buffet nướng hơn 150 món; phục vụ chu
            đáo, tỉ mỉ từ khi khách bước vào cho tới khi ra về,… Sakura Buffet
            mong muốn sẽ trở thành cái tên đầu tiên được nhắc đến khi khách hàng
            tìm kiếm một địa điểm thưởng thức buffet Nhật Bản.
          </Slider.Description>
